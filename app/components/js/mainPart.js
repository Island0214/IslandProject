        ...
        return (
            <div className={styles.singlePanel}>
                <div className={styles.card} onMouseEnter={this.handleMouseOver}
                     onMouseLeave={this.handleMouseOut} onClick={this.handleMouseClick}>
